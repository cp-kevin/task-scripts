...
rsync -e "ssh -o StrictHostKeyChecking=no -i deployer-ssh-key/deployer" target-webuser-mysql-creds/creds.cnf deployer@${TARGETIP}:/home/deployer/mysql_creds.cnf
